const CACHE='wasgehtheute-v1';
const ASSETS=['./','./index.html','./style.css','./enhancements.css','./app.js','./events-1.js','./events-2.js','./events-3.js','./manifest.webmanifest','./icon.svg','./event.html','./event-detail.js'];
