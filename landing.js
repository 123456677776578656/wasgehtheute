...
function schemaStatus(e){if(e.status==='postponed')return'https://schema.org/EventPostponed';if(e.status==='changed')return'https://schema.org/EventRescheduled';return'https://schema.org/EventScheduled'}
